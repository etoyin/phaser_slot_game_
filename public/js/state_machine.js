// v1.0 08.01.2024
// my function
_spinCount = Number(localStorage.getItem('spinCount')) || 0;
_loggedIn = localStorage.getItem('token') && localStorage.getItem('login');
function checkSpin(){
...
class PreSpinState
{
    ...
    enterFrom(oldState)
    {
        ...
        if (this.spinButton !== null)
        {
            ...
            // doU(_spinCount);
            if(!_loggedIn){
                _spinCount = _spinCount + 1;
                localStorage.setItem('spinCount', _spinCount);
